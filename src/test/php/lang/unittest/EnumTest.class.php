...
class EnumTest {
  ...
  #[Test, Condition(assert: 'fn() => class_exists("ReflectionEnum", false)')]
  ...
  #[Test, Expect(IllegalArgumentException::class), Condition(assert: 'fn() => class_exists("ReflectionEnum", false)')]
  ...
  public function static_member_not_in_enum_valuesOf() {
    Assert::equals(
      ...
      Enum::valuesOf(XPClass::forName('lang.unittest.Profiling'))
    );
  }
  ...
  public function static_member_not_acceptable_in_valueOf() {
    Enum::valueOf(XPClass::forName('lang.unittest.Profiling'), 'fixture');
  }
