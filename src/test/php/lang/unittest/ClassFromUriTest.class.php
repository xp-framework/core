...
abstract class ClassFromUriTest {
  ...
  public static function createBase() {
    ...
    self::$base->initialize(function($self) {
      ...
      $self->newType('class', 'lang.unittest.CLT2');
  ...
  public function from_a_relative_path() {
    Assert::equals(
      ...
      $this->fixture->loadUri($this->compose('lang', 'unittest', 'CLT2.class.php'))
    );
  }
  ...
  public function from_an_absolute_path() {
    Assert::equals(
      $this->fixture->loadClass('lang.unittest.CLT2'),
      $this->fixture->loadUri($this->compose(self::$base, 'lang',  'unittest', 'CLT2.class.php'))
    );
  }
