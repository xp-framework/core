...
class GenericsTest {
  ...
  private function types() {
    yield ['lang.unittest.ListOf<string>'];
    yield ['lang.unittest.ListOf<int|string>'];
    yield ['lang.unittest.Lookup<int, util.Binford>'];
    yield ['lang.unittest.ListOf<lang.unittest.Lookup<int, util.Binford>>'];
  }
