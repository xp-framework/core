...
class XPClassTest {
  ...
  public function getName_returns_fully_qualified_name() {
    Assert::equals('net.xp_framework.unittest.reflection.TestClass', $this->fixture->getName());
  }
  ...
  public function is_subclass_of_its_parent() {
    Assert::true($this->fixture->isSubclassOf('net.xp_framework.unittest.reflection.AbstractTestClass'));
  }
  ...
  public function is_not_subclass_of_itself() {
    Assert::false($this->fixture->isSubclassOf('net.xp_framework.unittest.reflection.TestClass'));
  }
  ...
  public function fixtures_parent_class_is_assignable_from_fixture() {
    Assert::true(XPClass::forName('net.xp_framework.unittest.reflection.AbstractTestClass')->isAssignableFrom($this->fixture));
  }
  ...
  public function trait_class_is_trait() {
    Assert::true(XPClass::forName('net.xp_framework.unittest.reflection.classes.TraitOne')->isTrait());
  }
