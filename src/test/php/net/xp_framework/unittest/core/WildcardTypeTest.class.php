...
class WildcardTypeTest {
  ...
  public function generic_vectors_are_instances_of_vector_of_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->isInstance($value->newInstance()));
  }

  #[Test, Values('nullableOfAny')]
  public function generic_vectors_are_assignable_to_vector_of_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->isAssignableFrom($value));
  }

  #[Test, Values('nullableOfAny')]
  public function generic_vectors_can_be_cast_to_vector_of_any($value) {
    $instance= $value->newInstance();
    Assert::equals($instance, WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->cast($instance));
  }

  #[Test, Values('hashTableOfAny')]
  public function generic_hashtables_are_not_instances_of_vector_of_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->isInstance($value->newInstance()));
  }

  #[Test, Values('hashTableOfAny')]
  public function generic_hashtables_are_not_assignable_to_vector_of_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->isAssignableFrom($value));
  }
  ...
  public function ungeneric_instances_are_not_instances_of_vector_of_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Nullable<?>')->isInstance($value));
  }
  ...
  public function generic_hashtables_are_instances_of_hash_of_any_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<?, ?>')->isInstance($value->newInstance()));
  }

  #[Test, Values('hashTableOfAny')]
  public function generic_hashtables_are_assignable_to_of_hash_of_any_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<?, ?>')->isAssignableFrom($value));
  }

  #[Test, Values('hashTableOfAny')]
  public function generic_hashtables_are_instances_of_map_of_any_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.IDictionary<?, ?>')->isInstance($value->newInstance()));
  }

  #[Test, Values('hashTableOfAny')]
  public function generic_hashtables_are_assignable_to_of_map_of_any_any($value) {
    Assert::true(WildcardType::forName('net.xp_framework.unittest.core.generics.IDictionary<?, ?>')->isAssignableFrom($value));
  }

  #[Test, Values('nullableOfAny')]
  public function generic_vectors_are_not_instances_of_hash_of_any_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<?, ?>')->isInstance($value->newInstance()));
  }

  #[Test, Values('nullableOfAny')]
  public function generic_vectors_are_not_assignable_to_hash_of_any_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<?, ?>')->isAssignableFrom($value));
  }

  #[Test, Values('unGenericInstances')]
  public function ungeneric_instances_are_not_instances_of_hash_of_any_any($value) {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<?, ?>')->isInstance($value));
  }

  #[Test]
  public function hash_table_of_string_Value_is_not_instance_of_hash_of_int_any() {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<int, ?>')->isInstance(
  ...
  public function hash_table_of_string_Value_is_assignable_top_hash_of_int_any() {
    Assert::false(WildcardType::forName('net.xp_framework.unittest.core.generics.Lookup<int, ?>')->isAssignableFrom(
      Type::forName('net.xp_framework.unittest.core.generics.Lookup<string, lang.Value>')
    ));
  }
