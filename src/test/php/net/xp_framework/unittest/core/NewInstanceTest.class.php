...
class NewInstanceTest extends \unittest\TestCase {
  ...
  #[@test, @expect(class= 'lang.XPException', withMessage= '/does not have a constructor, so you cannot pass any constructor arguments/')]
  public function anonymousClassWithoutConstructorNotCallableWithConstructArgs() {
