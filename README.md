...
```sh
$ cd ~/bin
$ curl -sSL https://baltocdn.com/xp-framework/xp-runners/distribution/downloads/e/entrypoint/xp-run-8.5.0.sh | sh
```
...
```sh
$ xp -v
XP 10.9.1-dev { PHP/8.0.3 & Zend/4.0.3 } @ Windows NT SURFACE 10.0 build 19042 (Windows 10) AMD64
