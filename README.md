...
```sh
$ cd ~/bin
$ curl -sSL https://bintray.com/artifact/download/xp-runners/generic/setup-8.2.2.sh | sh
```
...
```sh
$ xp -v
XP 10.5.2-dev { PHP/8.0.0 & Zend/4.0.0 } @ Windows NT SURFACE 10.0 build 19042 (Windows 10) AMD64
