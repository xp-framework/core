...
```sh
$ cd ~/bin
$ wget 'https://github.com/xp-framework/xp-runners/releases/download/v5.3.0/setup' -O - | php
```
...
```sh
$ xp -v
XP 6.2.5-dev { PHP 5.6.9 & ZE 2.6.0 } @ Windows NT SLATE 6.3 build 9200 (Windows 8.1) i586
