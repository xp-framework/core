...
```sh
$ cd ~/bin
$ curl -sSL https://bintray.com/artifact/download/xp-runners/generic/setup-7.9.2.sh | sh
```
...
```sh
$ xp -v
XP 9.1.1-dev { PHP 7.1.11 & ZE 3.1.0 } @ Windows NT SLATE 10.0 build 16299 (Windows 10) AMD64
